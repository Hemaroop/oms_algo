...
_scriptCreationTime = datetime.utcnow()
...
for _orderIndex in range(_numOrders):
    ...
    if (_orderType % 2) == 1:
        _orderCommand = '{0} {1} {2} {3} {4} {5}\n'.format(_pythonEnv, omsClientCommands[_clientCommandIndex], _participantId, _orderType, _orderQty, _limitPrice)
    else:
        _orderCommand = '{0} {1} {2} {3} {4}\n'.format(_pythonEnv, omsClientCommands[_clientCommandIndex], _participantId, _orderType, _orderQty)
