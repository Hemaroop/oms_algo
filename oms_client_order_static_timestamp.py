...
def print_order_help():
    print('python3 oms_client_order_static_timestamp.py -i participant_id -t order_type -q order_qty -gt number of days -l limit_price (used only if order_type is 1 or 3)')
