...
class BTS_Quote:
    ...
    def __init__(self, _participantId, _bidPrice, _bidSize, _askPrice, _askSize, _min_pfill_qty=0, _time_In_Force_Remaining = 14, _quote_date_time=datetime.now()):
        ...
        self._buyOrder = bts_order.BTS_Order(_participantId, 1, _bidSize, _bidPrice, _min_pfill_qty, self._timeInForceRemaining, _quote_date_time)
        #Create sell, limit, partial order
        self._sellOrder = bts_order.BTS_Order(_participantId, 5, _askSize, _askPrice, _min_pfill_qty, self._timeInForceRemaining, _quote_date_time)
